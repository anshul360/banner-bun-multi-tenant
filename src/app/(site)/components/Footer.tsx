        ...
        <div className={'flex flex-col space-y-8 lg:flex-row lg:space-y-0'}>
          ...
          >
            <div className={'flex flex-col space-y-4'}>
              <div>
                <LogoImage className={'w-[40px] md:w-[50px]'} />
              </div>
              ...
              <div className={'flex text-xs text-gray-500 dark:text-gray-400'}>
                <p>
                  © Copyright {YEAR}<br/> {configuration.site.siteName}.
                  <br/><Trans i18nKey={'common:allRightReserved'} />
                </p>
              </div>
            </div>
          </div>
            ...
            <div>
              <div className={'flex flex-col space-y-4'}>
                ...
                <FooterSectionList>
                  ...
                  <FooterLink>
                    <Link href={'https://x.com/AnshCooll'} target="_blank">
