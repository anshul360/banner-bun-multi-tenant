...
import { AnimatedBeam } from "~/core/magicui/animated-beam";
import LogoImage from "~/core/ui/Logo/LogoImage";
import makeimage from "public/assets/images/make.png"
import Image from "next/image";

export default function AnimatedSystem() {
    ...
    return <div
        className="relative flex w-full max-w-4xl items-center justify-center overflow-hidden rounded-lg bg-background p-10 "
        ref={containerRef}
    >
        <div className="flex h-full w-full flex-col items-stretch justify-between gap-10">
            <div className="flex flex-row justify-between items-center">
                {/* <div className=" flex justify-between w-full items-center " ref={containerRef}> */}
                <div className=" flex flex-col space-y-4">
                    ...
                    <div className={cn(
                        ...
                        <Image src={makeimage} alt="make.com" className=" size-8" />
                    </div>
                </div>
                <div className={cn(
